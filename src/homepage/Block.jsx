...
const Block = () => {
    return (
      ...
      <svg className="blocks" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 701 1024" >
  
          <g className="blocks-large" stroke-width="7">
              <g>
          ...
          <g className="blocks-small" stroke-width="4">
              <g>
              ...
              <g>
                <g transform="translate(497 984)">
                  <rect x="70s" y="70" width="150" height="150"/>
                </g>
            </g>
            <g>
                <g transform="translate(497 984)">
                  <rect x="80" y="80" width="150" height="150"/>
                </g>
            </g>
          </g>
