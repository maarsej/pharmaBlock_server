...
exports.seed = function(knex, Promise) {
  ...
  .then(function () {
    return Promise.all([
      ...
      knex('drugs').insert({ id: 22, pharmaco_pubaddr: '0x9abbFB9219b405Fb2B0C89D4f07522CF32001A8B' , brand_name: 'Belaxamine', price_per_mg: 1, image_url: 'Medication.png ', generic_id: 4  }),
